...
import dev.opalsopl.animania_refresh.fluid.ExtendedFluidTest;
...
public class AllBlocks {
    ...
    public static final RegistryObject<LiquidBlock> SLOP_BLOCK = BLOCKS.register("slop",
            () -> new ExtendedFluidTest(AllFluids.SLOP_SOURCE_FLUID, BlockBehaviour.Properties.copy(Blocks.WATER)));
